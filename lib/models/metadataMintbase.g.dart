part of 'metadataMintbase.dart';

MetadataMintbase _$MetadataMintbaseFromJson(Map<String, dynamic> json) =>
    MetadataMintbase(
...
Map<String, dynamic> _$MetadataMintbaseToJson(MetadataMintbase instance) =>
    <String, dynamic>{
